            ...
            <nav>
                <ul>
                    ...
                    <?php if (isset($_SESSION['user_id'])): ?>
                        ...
                        <li><span style="color: var(--primary-color);">Hola, <?php echo htmlspecialchars($_SESSION['username']); ?></span></li>
                        <li><a href="logout.php" class="btn btn-secondary" style="padding: 0.5rem 1rem; font-size: 0.9rem;">Logout</a></li>
                    <?php else: ?>
                        <li><a href="login.php">Login</a></li>
                        <li><a href="register.php" class="btn btn-secondary" style="padding: 0.5rem 1rem; font-size: 0.9rem;">Register</a></li>
                    <?php endif; ?>
                </ul>
            </nav>
        </div>
