...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_FILES['image']) && $_FILES['image']['error'] === UPLOAD_ERR_OK) {
        ...
        // Fallback or alternative: URL input
    ...
    <div class="auth-form-container" style="max-width: 600px;">
        ...
        <form action="add_product.php" method="POST" enctype="multipart/form-data" class="auth-form">
            ...
            <div class="form-group">
                ...
                <input type="number" id="price" name="price" step="0.01" min="0" required value="<?php echo isset($price) ? htmlspecialchars($price) : ''; ?>">
            </div>
            
            <div class="form-group">
                <label for="category">Categoría</label>
                <select id="category" name="category" required style="width: 100%; padding: 0.8rem; border-radius: 8px; background: rgba(0,0,0,0.2); color: var(--text-color); border: 1px solid rgba(255, 143, 163, 0.2);">
            ...
            <div class="form-group">
                ...
                <textarea id="description" name="description" rows="4" style="width: 100%; padding: 0.8rem; border-radius: 8px; background: rgba(0,0,0,0.2); color: var(--text-color); border: 1px solid rgba(255, 143, 163, 0.2);"><?php echo isset($description) ? htmlspecialchars($description) : ''; ?></textarea>
            </div>
